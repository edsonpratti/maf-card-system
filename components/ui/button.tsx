    ...
    "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 active:scale-[0.98]",
    {
        variants: {
            variant: {
                ...
                "outline-success":
                    "border border-green-600 text-green-600 bg-transparent hover:bg-green-50 dark:hover:bg-green-950",
                "outline-warning":
                    "border border-yellow-500 text-yellow-600 bg-transparent hover:bg-yellow-50 dark:hover:bg-yellow-950",
                "outline-destructive":
                    "border border-red-500 text-red-600 bg-transparent hover:bg-red-50 dark:hover:bg-red-950",
                "outline-info":
                    "border border-blue-600 text-blue-600 bg-transparent hover:bg-blue-50 dark:hover:bg-blue-950",
            },
            size: {
